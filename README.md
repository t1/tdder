...
| `mlx` (pi only)       | —                             | —                                                                                                                                                                                                 | Injects default MLX repetition settings via `before_provider_request`; auto-recovers when the local model leaks tool-call XML into its thinking output and stalls |
